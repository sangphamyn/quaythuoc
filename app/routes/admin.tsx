        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-4 border-b">
              <Link to="/admin">
                ...
                <span className="ml-2 text-lg font-semibold text-gray-800">Smart Thuốc</span>
                </div>
              </Link>
            <button
          ...
          <div className="flex-1 overflow-y-auto py-4">
            <nav className="px-2 space-y-1">
              <Link
                to="/admin"
                className={`${
                  isActive("/admin") && !isActive("/admin/cabinets") && !isActive("/admin/categories") && !isActive("/admin/units") && !isActive("/admin/products") && !isActive("/admin/suppliers") && !isActive("/admin/purchase-orders") && !isActive("/admin/invoices") && !isActive("/admin/staff") && !isActive("/admin/reports")  ? 
